      			...
      			<div class="card">
      				...
      				<div class="card-content collapse show">
                        ...
                        <form class="" action="<?php echo base_url('panel/task/updateRequestTask/do_update/'.my_simple_crypt($key->id_tasklist,'e'));?>" method="post">
                            ...
                            <div class="form-group">
                            <label class="ml-1 control-label" for="bidang_kerja">Bidang Kerja</label><span style="color: red">*</span>
                            <div class="col-md-10">
                              <select class="form-control border-primary" name="bidang_kerja" required>
                                <option value="<?php echo $key->bidang_kerja?>"><?php echo $key->bidang_kerja?></option>
                                <option value="Teknikal">Bidang Teknikal</option>
                                <option value="Manajerial dan Kepemimpinan">Bidang Manajerial dan Kepemimpinan</option>
                                <option value="Administrasi">Bidang Administrasi</option>
                              </select>
                            </div>
                            </div>

      		...
      		<div class="col-7">
                 ...
                 <table class="table table-hover">
                      <tbody>
                        ...
                        <tr>
                          <td>Status Rencana Kerja</td>
                          <td>
                            <?php 
                              if($key->status_persetujuan == "Decline")
                              echo "<a class='btn btn-sm btn-danger' style='color:white'>Ditolak</a>";
                              elseif($key->status_persetujuan == "Waiting")
                              echo "<a class='btn btn-sm btn-warning' style='color:white'>Menunggu</a>";
                            ?>  
                          </td>
                        </tr>
                        <?php if($key->status_persetujuan == "Decline"){ foreach($keterangan as $key2):?>
                        <tr>

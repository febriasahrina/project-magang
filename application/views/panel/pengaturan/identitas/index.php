                  ...
                  <div class="row">
                    <div class="form-group col-12 mb-2">
                      ...
                      <input class="form-control border-primary" type="text" placeholder="ADDRESS" value="<?php echo $key->address;?>">
  								...
  								<div class="row">
  									<div class="form-group col-12 mb-2">
  										<label class="sr-only" for="userinput5">E-Mail</label>
  										<input class="form-control border-primary" type="text" placeholder="E-Mail" name="email" value="<?php echo $key->email;?>">
  									</div>
  								</div>
  								<div class="row">
  									<div class="form-group col-12 mb-2">

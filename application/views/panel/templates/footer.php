...
<footer class="footer footer-static footer-light navbar-border">
  <p class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2"><span class="float-md-left d-block d-md-inline-block">&copy; 2020 <?php echo $footer;?></span><span class="float-md-right d-none d-lg-block"><?php echo $apps_name.' '.$apps_version;?></span></p>
</footer>
<!-- END: Footer-->

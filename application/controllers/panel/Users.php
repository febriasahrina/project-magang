...
class Users extends CI_Controller {
	...
	public function list($param1='')
	{
		...
		if ($param1=='deleted') {
			...
			$data['subtitle'] = 'List Pengguna';
			$data['status'] = 'Aktif';
			$data['users'] = $this->UsersModel->get_users_order_by('hak_akses','ASC');
			$data['content'] = 'panel/manajemen_pengguna/pengguna/index';
			$this->load->view('panel/content',$data);
		}
	}
	...
	public function update($param1='',$param2=''){
		...
		if ($param1=='do_update') {
			...
			//$data['hak_akses'] = $this->GeneralModel->get_general('tb_hak_akses');
			$data['hak_akses'] = $this->GeneralModel->get_general_order_by('tb_hak_akses','nama_hak_akses','ASC');
	...
	public function rbac_list(){
		...
		$data['rbac'] = $this->GeneralModel->get_general_order_by('tb_hak_akses','nama_hak_akses','ASC');
